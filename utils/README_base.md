...
The README gets automatically updated when changes of the folder structure or README_base are pushed to a branch and when a pull request is merged to the main branch.
